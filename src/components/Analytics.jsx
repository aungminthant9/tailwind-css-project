         ...
         <div className="max-w-[1240] mx-auto grid md:grid-cols-2">
            ...
            <div className='flex flex-col justify-center'>
                ...
                <p>
                    ...
                    Pariatur autem recusandae dicta totam, sint, natus aut nihil, 
                    animi nobis alias distinctio similique odit illum 
                    sit doloremque neque officiis. Dolore, consequuntur?
                </p>
